...
const oldCode = fs.readFileSync('apps/gateway/src/controllers/chat.ts', 'utf8');

let newCode = `import { FastifyInstance } from 'fastify';
...
fs.writeFileSync('apps/gateway/src/controllers/chat.ts', newCode);
console.log('Successfully wrote chat.ts');
